#!/usr/bin/env python3
"""
Summarize hard-collision dynamic MPPI robustness trials by case and variant.
...
Default input:
    dynamic_block_hard_robustness_trials.csv

Default outputs:
    dynamic_block_hard_robustness_selected_summary_long.csv
    dynamic_block_hard_robustness_selected_summary_wide.csv
    dynamic_block_hard_robustness_selected_failure_reasons.csv
    dynamic_block_hard_robustness_selected_metrics_table.pdf

Examples:
    python plot_robustness_metrics_selected.py

    python plot_robustness_metrics_selected.py \
        --input dynamic_block_hard_robustness_trials.csv \
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--input",
        default="dynamic_block_hard_robustness_trials.csv",
        help="Detailed trial CSV produced by dynamic_block_hard_robustness.py.",
    )
    parser.add_argument(
        "--group-by",
        nargs="+",
    ...
    parser.add_argument(
        "--output-prefix",
        default="dynamic_block_hard_robustness_selected",
...
def render_pdf_table(
    ...
    with PdfPages(output_path) as pdf:
        for title, columns in [
            (
                "Hard-collision robustness metrics\n"
